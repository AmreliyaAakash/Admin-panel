...
export const EditorData = () => (
  <div>
   <div className="p-6 md:p-10 max-w-5xl mx-auto text-gray-800 space-y-10">
  <h1 className="text-4xl font-bold text-blue-600">Try React</h1>
  <p className="text-lg">
    React has been designed from the start for gradual adoption. You can use as little or as much React as you need.
  </p>

  <section className="space-y-4">
    <h2 className="text-2xl font-semibold text-gray-700">🌐 Online Playgrounds</h2>
    <p>If you're interested in experimenting with React, try using these online code playgrounds:</p>
    ...
    <p>
      You can also download a basic HTML file and open it in your browser. This is best for simple demos only.
    </p>
  </section>

  <section className="space-y-4">
    <h2 className="text-2xl font-semibold text-gray-700">⚙️ Add React to a Website</h2>
    <p>
      You can add React to an HTML page in less than a minute. Expand React’s presence gradually or keep it confined to small widgets.
    </p>
  </section>

  <section className="space-y-4">
    <h2 className="text-2xl font-semibold text-gray-700">🚀 Create a New React App</h2>
    <p>
      Start with a simple script-tag setup or move to toolchains like Create React App, Vite, or Next.js as your app grows. These allow you to leverage the full power of the React ecosystem.
    </p>
  </section>

  <section className="space-y-4">
    <h2 className="text-2xl font-semibold text-gray-700">📚 Learn React</h2>
    <ul className="list-disc list-inside space-y-1">
      <li>Prefer hands-on learning? Start with the <strong>practical tutorial</strong>.</li>
      <li>Prefer theory? Go through the <strong>Main Concepts Guide</strong>.</li>
    </ul>
    <p>Learning React takes time—stick with it and you'll master it.</p>
  </section>

  <section className="space-y-4">
    <h2 className="text-2xl font-semibold text-gray-700">🧩 First Examples</h2>
    <p>Visit the React homepage and experiment with live examples—even beginners can try changing code and see results instantly.</p>
  </section>

  <section className="space-y-4">
    <h2 className="text-2xl font-semibold text-gray-700">🧑‍🎓 React for Beginners</h2>
    <p>
      If official docs are too fast-paced, check out
      <span className="text-blue-600 font-medium"> “React: A Beginner’s Guide” by Tania Rascia</span>.
    </p>
    <p>Afterward, return to the React docs with better understanding!</p>
  </section>

  <section className="space-y-4">
    <h2 className="text-2xl font-semibold text-gray-700">🎨 React for Designers</h2>
    <p>Coming from a design background? There are special resources to help you transition smoothly into using React.</p>
  </section>

  <section className="space-y-4">
    <h2 className="text-2xl font-semibold text-gray-700">📘 JavaScript Resources</h2>
    <p>
      Knowing JavaScript helps a lot. Review JS basics before jumping into React. A 30–60 min refresher can boost your confidence.
    </p>
  </section>
</div>
